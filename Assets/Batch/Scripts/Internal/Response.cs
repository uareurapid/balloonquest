...
namespace Batch.Internal
{
	...
	internal class Response
	{
		...
		public string GetAdDisplayEvent()
		{
			return responseData.GetString("event", "null"); 
		}
		...
		public AdsError GetAdsError()
		{
			...
			{
				return AdsError.UNEXPECTED_ERROR;
			}

			return (AdsError) Enum.Parse(typeof(AdsError), responseData.GetString("error", "UNEXPECTED_ERROR"));
		}
