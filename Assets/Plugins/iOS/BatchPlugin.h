...
#import <BatchBridge/BatchAds.h>

#import "AppDelegateListener.h"

#define PluginVersion               @"1.3.1"

@interface BatchUnityInterstitial : NSObject <BatchAdsDisplayDelegate>

/**
 * Instanciate a new Unity Interstitial that's auto retained
 */
...
@property (assign) BOOL selfRetained;
@property (strong) NSNumber* handle;
